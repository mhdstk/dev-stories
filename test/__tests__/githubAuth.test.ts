import { GitHubAuthService } from '../../src/services/githubAuth';
...
describe('GitHubAuthService', () => {
  ...
  beforeEach(() => {
    ...
    authService = GitHubAuthService.getInstance(mockContext);
  });
  ...
  describe('authenticate', () => {
    it('should successfully authenticate and return user data', async () => {
      ...
      (global as any).mockVscode.authentication.getSession.mockResolvedValue(mockSession);
    ...
    it('should return null if authentication fails', async () => {
      (global as any).mockVscode.authentication.getSession.mockResolvedValue(null);
  ...
  describe('singleton pattern', () => {
    it('should return the same instance when called multiple times', () => {
      const instance1 = GitHubAuthService.getInstance(mockContext);
